...
# copy contents from build to cordapp folder
# since it can only be done at run time because cordapps folder is volume mounted
cp /opt/corda/build/* /opt/corda/cordapps
